...
- `src/content/*/sample-*`는 스키마 검증과 새 글 복사용 예시(`draft: true`)입니다. 컬렉션에 실제 글이 생기면 지웁니다 — 프로젝트는 2026-09-22에 `sample-project`를 지웠으니 새 프로젝트는 `pointer-quest/`를 복사합니다. 주요 기능 `description`은 Markdown이 아니라 일반 텍스트로 나옵니다.
