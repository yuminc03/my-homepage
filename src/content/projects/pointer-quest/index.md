...
처음에는 Swift Student Challenge 2026 제출용 게임으로 만들었습니다. 수상하지 못한 뒤에는 바로 이어 만들지 않고, 이 앱이 무엇을 위한 앱인지부터 다시 생각했습니다. 그렇게 게임이 아니라 학습 도구로 방향을 정하고 나서야 다시 손을 댔습니다.

- **2026.01 – 02** Swift Student Challenge 제출용으로 개발. 미션·레벨 클리어가 있는 게임 형태였습니다
- **2026.03 – 06** 개발을 멈추고 방향을 다시 고민했습니다. 무엇을 남기고 무엇을 뺄지 정하는 기간이었습니다
- **2026.07 – 09** 인터랙티브 학습 도구로 다시 만들었습니다. 게임 프레이밍을 걷어내고, 레슨을 데이터로 분리하고, 개념 카드와 완료 피드백을 새로 넣었습니다
- **2026.09.15** `1.0.0`을 App Store에 출시했습니다. 지금은 `1.1.0`을 개발하고 있습니다
